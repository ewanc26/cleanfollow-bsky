...
Guidance for AI coding agents working in **cleanfollow-bsky**.

## Project overview

Hidden accounts unfollow tool for Bluesky
...
Sync AGENTS.md from zincfox; Sync CONTRIBUTING.md from zincfox; Sync AGENTS.md from zincfox; Sync CONTRIBUTING.md from zincfox; update deps